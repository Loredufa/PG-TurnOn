        ...
        <View style={styles.detail}>
          <View style={styles.info}>
            ...
            <Text style={styles.text}>
              Recorda que para reservar hay que realizar una seña del 10%, en
              caso de cancelar con 48hs de anticipación recibiras un voucher
              para utilizar en la misma cancha.
            </Text>
            <View style={styles.column}>
              <Text>Monto a señar: </Text>
              <Text>${Math.round(bookingRef?.court.price / 10)}</Text>
            </View>
          </View>
